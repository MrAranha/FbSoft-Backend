...
namespace FbSoft_MediatrHandling.EntityRequests.Users.AutoMapper
{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile() { 
            CreateMap<GetUserRequest, GetUserResult>();
            CreateMap<GetUserResult, GetUserRequest>();
            CreateMap<GetUserResult, TB_Users>();
            CreateMap<TB_Users, GetUserResult>().ReverseMap();
        }
    }
}
